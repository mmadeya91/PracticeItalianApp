            ...
            ZStack(alignment: .topLeading){
                ...
                ScrollViewReader {scrollView in
                    ScrollView(.vertical, showsIndicators: false) {
                        ...
                        ForEach(0..<placeHolderArray.count, id: \.self) {i in
                            ...
                            if placeHolderArray[i].isQuestion {
                                ...
                                dialogueCaptionBoxNoQuestionIPAD(fullSentence: placeHolderArray[i].fullSentence, questionNumber: i, currentQuestionNumber: $currentQuestionNumber).transition(.slide).animation(.easeIn(duration: 0.75)).padding([.leading, .trailing], 15).padding(.top, 15).padding(.bottom, 5)
                    ...
                    Image("sittingBear")
                        ...
                        .offset(x: 200, y: animatingBear ? +20 : 780)
